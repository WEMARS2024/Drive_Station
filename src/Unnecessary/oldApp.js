  ...
  return (
    <div className="bg-purple-700 min-h-screen text-black">
      <div className="grid grid-cols-2" >
        {/*<div id="intel camera" className="col-span-0">
          <IntelCamera />
        </div>*/}
        {/*<div className="col-span-1 p-2">
          <div id="espCam1">
            <div className="relative border-solid border-4 border-black top-[115px] right-[80px] w-[475px] h-[330px] rounded-lg bg-slate-200">
              <span className="relative text-white bg-black rounded-md bottom-0 right-1 p-1 pl-10 px-2 font-serif">Camera 2</span>
        ...
        <div className="row-span-1 col-span-1">
          <div className="flex-1 p-2 pl-36 flex flex-row h-96">
          ...
          <div id="GPS Data" className="pl-36" >
            <GPSMap></GPSMap>
          </div>
        </div>
      </div>
